...
public class addPatient extends javax.swing.JFrame {
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        if (con != null) {
            ...
            String sql = "insert into Patient(firstName,lastName,mobileno, gender, age, bloodgroup,address,disease,patient_type) values (?,?,?,?,?,?,?,?,?)";
            try {
                ...
                prp.setInt(5, age);
                prp.setString(6, blood);//prp.setString(7, dept);
                prp.setString(7, address);
                prp.setString(8, disease);
                prp.setString(9, patienttype);
                prp.execute();
