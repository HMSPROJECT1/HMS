...
public class EditReceptionist extends javax.swing.JFrame {
    ...
    public EditReceptionist(int a) {
     ...
     private void loadtotextfield(){
        ...
        String sql = "SELECT * FROM Receptionist,Staff Where rId=? AND stId=staffId";
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        if (con != null) {
            ...
            try {
                ...
                String sql2 = "Update Receptionist set username = ? ,password = ? WHERE rId= ?";
                ...
                JOptionPane.showMessageDialog(null, "Data Saved to Receptionist");
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, e);
            }
        }
