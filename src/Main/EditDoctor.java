...
public class EditDoctor extends javax.swing.JFrame {
    ...
    private void loadtotextfield(){
        ...
        String sql = "SELECT * FROM Doctor,Staff Where doctorId=? AND stId=staffId";
        ...
        try{
            rs.next();
                ...
                //Departmentbox.setSelectedIndex(rs.getInt("department"));
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        if (con != null) {
            ...
            try {
                ...
                prp.execute();
                JOptionPane.showMessageDialog(null, "Data Saved to Staff");
                 
                
                String sql2 = "Update Doctor set deptId = ?,username = ? ,password = ? WHERE doctorId= ?";
                ...
                JOptionPane.showMessageDialog(null, "Data Saved to Doctors");
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, e);
            }
        }
